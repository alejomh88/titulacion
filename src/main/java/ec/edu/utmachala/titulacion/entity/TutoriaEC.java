...
@Data
@Entity
@Table(schema = "exetasi", name = "\"tutoriasEC\"")
public class TutoriaEC {

	@Id
	@SequenceGenerator(allocationSize = 1, name = "TUTORIASEC_ID_GENERATOR", sequenceName = "\"tutoriasEC_id_seq\"")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TUTORIASEC_ID_GENERATOR")
	...
	@ManyToOne
	@JoinColumn(name = "\"estudianteExamenComplexivoPP\"", nullable = false)

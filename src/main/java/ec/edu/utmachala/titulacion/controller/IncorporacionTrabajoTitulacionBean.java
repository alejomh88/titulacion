...
@Controller
@Scope("session")
public class IncorporacionTrabajoTitulacionBean implements Serializable {
	...
	public void eliminar() {
		estudianteTrabajoTitulacion.setNumeroActaIncorporacion(null);
		estudianteTrabajoTitulacion.setFechaActaIncorporacion(null);
		...
		// estudianteTrabajoTitulacionService.actualizar(estudianteTrabajoTitulacion);
		UtilsAplicacion.presentaMensaje(FacesMessage.SEVERITY_INFO, "Borró el acta de incorporación", "cerrar", true);
	}
	...
	public Date getFechaActaIncorporacion() {
		return fechaActaIncorporacion;
	}
	...
	public void insertarResolucion() {
		if (fechaActaIncorporacion == null) {
			UtilsAplicacion.presentaMensaje(FacesMessage.SEVERITY_INFO, "Ingrese la fecha de resolución", "cerrar",
					false);
		} else if (numeroActaIncorporacion == null || numeroActaIncorporacion.compareToIgnoreCase("") == 0) {
			...
			for (EstudianteTrabajoTitulacion ett : listEstudiantesTrabajosTitulacionesSeleccionados) {
				ett.setFechaActaIncorporacion(fechaActaIncorporacion);
				ett.setNumeroActaIncorporacion(numeroActaIncorporacion);
	...
	public void setFechaActaIncorporacion(Date fechaActaIncorporacion) {
		this.fechaActaIncorporacion = fechaActaIncorporacion;
	}

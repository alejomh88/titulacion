...
@Controller
@Scope("session")
public class ValidarCalificacionTrabajoTitulacionBean implements Serializable {
	...
	public void cargarActa(EstudianteTrabajoTitulacion estudianteTrabajoTitulacion) {
		...
		BigDecimal bd = UtilsMath.newBigDecimal();
	...
	public void validarCalificacion() {
		estudianteTrabajoTitulacion.setValidarCalificacion(true);
		...
		UtilsAplicacion.presentaMensaje(FacesMessage.SEVERITY_INFO, "Valido correctamente la calificación", "cerrar",
				true);
	}

...
@Controller
@Scope("session")
public class IncorporacionTemasPracticosBean implements Serializable {
	...
	public void eliminar() {
		temaPractico.setNumeroActaIncorporacion(null);
		temaPractico.setFechaActaIncorporacion(null);
	...
	public void insertarResolucion() {
		if (fechaActaIncorporacion == null) {
			...
			for (EstudianteExamenComplexivoPP tp : listTemaPracticosSeleccionados) {
				tp.setFechaActaIncorporacion(fechaActaIncorporacion);
				tp.setNumeroActaIncorporacion(numeroActaIncorporacion);

...
@Controller
@Scope("session")
public class ValidarCalificacionTemaPracticoBean implements Serializable {
	...
	public void validarCalificacion() {
		if (consultaOrdGra == 1)
			temaPractico.setValidarCalificacionOrdinaria(true);
		else
			temaPractico.setValidarCalificacionGracia(true);

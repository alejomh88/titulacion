...
@Controller
@Scope("session")
public class ResolucionAptitudLegalTrabajoTitulacionBean implements Serializable {
	...
	public void eliminar() {
		estudianteTrabajoTitulacion.setResolucionAptitudLegal(null);
		estudianteTrabajoTitulacion.setFechaResolucionAptitudLegal(null);
	...
	public void insertarResolucion() {
		if (fechaResolucionAptitudLegal == null) {
			...
			UtilsAplicacion.presentaMensaje(FacesMessage.SEVERITY_INFO, "Ingrese el número de resolución", "cerrar",
					false);
		} else {
			for (EstudianteTrabajoTitulacion ett : listEstudiantesTrabajosTitulacionesSeleccionados) {
				ett.setFechaResolucionAptitudLegal(fechaResolucionAptitudLegal);
				ett.setResolucionAptitudLegal(numeroResolucionAptitudLegal);
